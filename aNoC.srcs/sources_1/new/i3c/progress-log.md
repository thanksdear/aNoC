...
>
> 归档说明：本文记录的是 2026-07-21 的历史快照。迁移到 active
> target agent 和 UVM regression 后，旧的 `tb/unit/tb_i3c_top.sv`、
> `tb/unit/tb_sync_fifo.sv` 及其 Vivado filelist 已删除；下文相关命令仅作
> 历史记录，不能用于当前版本。
