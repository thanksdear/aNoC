...
class axi_lite_slave_write_seq extends uvm_sequence #(axi_lite_slave_txn);
  `uvm_object_utils(axi_lite_slave_write_seq)
  function new(string name = "axi_lite_slave_write_seq"); 
    super.new(name); 
  endfunction
